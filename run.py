...
import pyfiglet # Import the pyfiglet module to creati ASCII art
# From https://www.geeksforgeeks.org/python-ascii-art-using-pyfiglet-module/ Style text
import time 
...
def get_username():
    ...
    while True: ## Loop if the user wnats to play
        ...
        if play != "y" and play != "n": ## If user answers anything other than 'y/n'
    ...
    while True: ## Loop 
        ...
        while "_" in hidden_word and not game.game_over():
            ...
            if guess in word: # Checks if guess is in the word
                for i, letter in enumerate(word): # Checks both index and letter
                    if letter == guess:
            ...
            if "".join(hidden_word) == word: # Checks if hidden word is complete
        ...
        while True: # Loop to check if user wants to play again
            ...
            if play_again == "n":
                ...
                print("Please enter 'y' or 'n'!") # User must answer 'y' or 'n'
